...
def add_maskdino_config(cfg):
    ...
    cfg.MODEL.SEM_SEG_HEAD.text_categories=16
    cfg.MODEL.SEM_SEG_HEAD.dim_projection=512
    cfg.MODEL.text_embeddings_path=""
...
def add_eva_config(cfg):
    ...
    cfg.MODEL.EVA02.CHECKPOINT = False
