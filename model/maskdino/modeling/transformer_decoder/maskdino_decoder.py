...
class MaskDINODecoder(nn.Module):
    ...
    def from_config(cls, cfg, in_channels, mask_classification):
        ...
        ret["dim_projection"] = cfg.MODEL.SEM_SEG_HEAD.dim_projection
        ret["text_embeddings_path"] = cfg.MODEL.text_embeddings_path
        ret["text_categories"]=cfg.MODEL.SEM_SEG_HEAD.text_categories
    ...
    def forward(self, x, mask_features, masks,targets=None):
        ...
        if self.two_stage:
            ...
            enc_outputs_class_unselected = torch.einsum("bqc,nc->bqn", class_embed, self.category_embed)
    ...
    def forward_prediction_heads(self, output, mask_features,pred_mask=True):
        ...
        outputs_class = torch.einsum("bqc,nc->bqn", class_embed, self.text_embeddings)  # [bz,n,80]
