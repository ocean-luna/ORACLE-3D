...
class DeepLabHead(nn.Module):
    def __init__(self, config, in_channels, num_classes, aspp_dilate=[12, 24, 36]):
    ...
    def forward(self, feature):
        ...
        logist = F.conv2d(self.classifier(feature), self.text_embeddings[:, :, None, None])
...
class deeplabv3_resnet50(nn.Module):
    def __init__(self, config):
        ...
        inplanes = 2048
        classifier = DeepLabHead(config, inplanes, num_classes, aspp_dilate)
